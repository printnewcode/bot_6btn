...
"""Common"""
start = bot.message_handler(commands=["start"])(startBot)

admin_check_handler = bot.callback_query_handler(lambda c: c.data.startswith("admin-pay"))(admin_check_handler)
callback_r = bot.callback_query_handler(func=lambda call: True)(callback_r)